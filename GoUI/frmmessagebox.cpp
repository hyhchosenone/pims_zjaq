...
{
    if (type == 0) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/Resources/image/msg_info.png);");
        ui->btnCancel->setVisible(false);
        ui->lab_Title->setText("提示");
    } else if (type == 1) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/Resources/image/msg_question.png);");
        ui->lab_Title->setText("询问");
    } else if (type == 2) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/Resources/image/msg_error.png);");
        ui->btnCancel->setVisible(false);
